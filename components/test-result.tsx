      ...
      <div className="w-full max-w-4xl space-y-8 animate-fadeInUp">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <Card className="p-6 shadow-lg border-0 bg-white rounded-xl text-center">
            <p className="text-sm font-semibold text-muted-foreground mb-2">Total Score</p>
          ...
          {/* Percentage Card */}
          <Card className="p-6 shadow-lg border-0 bg-white rounded-xl text-center">
            <p className="text-sm font-semibold text-muted-foreground mb-2">Completion Rate</p>
          ...
          <Card className={`p-6 shadow-lg border-0 rounded-xl text-center ${interpretation.bgColor}`}>
            <p className="text-sm font-semibold text-muted-foreground mb-2">Assessment Level</p>
        ...
        <Card className="p-8 shadow-lg border-0 bg-white rounded-xl">
          <h2 className="text-2xl font-bold text-foreground mb-6">Score Distribution</h2>
          <ResponsiveContainer width="100%" height={300}>
            <BarChart data={chartData}>
              ...
              <YAxis stroke="#6b7280" />
              <Tooltip 
                contentStyle={{ backgroundColor: '#fff', border: 'none', borderRadius: '8px', boxShadow: '0 4px 6px rgba(0,0,0,0.1)' }}
                formatter={(value) => `${value} points`}
              />
              <Bar dataKey="score" fill="url(#gradientBar)" radius={[8, 8, 0, 0]} />
              <defs>
        ...
        <Card className={`p-8 shadow-lg border-0 rounded-xl ${interpretation.bgColor}`}>
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-foreground">What This Means</h3>
            <p className="text-base text-foreground leading-relaxed">
              {interpretation.description}
            </p>
            <div className="pt-2 border-t border-border/50">
              <p className="text-xs text-muted-foreground italic">
                * This assessment is for self-reflection only and should not replace professional mental health evaluation.
              </p>
            </div>
          </div>
        </Card>
